...
\begin{titlepage}
\centering
{\Huge \textbf{Software Requirement Specification for Project Mirage (SRS)}\\[1.5cm]}
{\Large Version 2.0.0\\[0.5cm]}
...
2.0 & Final, significant changes, and title & \today \\ \hline
\end{tabularx}
\newpage
...
\subsection{Purpose}
The main purpose of a Software Requirement Specification document is to serve as a detailed, structured guide that describes a software system's purpose, features, and requirements, acting as a blueprint for development and a contract between stakeholders. It will minimize misunderstandings by providing a sole source of truth for what the software must do, and it will also ensure the final product meets business and user needs.
...
\begin{itemize}
    ...
    \item A key interactive feature is the ability to perform a "dry run". This allows users to preview the exact changes the software would make to their files and directories without implementing them, enabling confirmation before committing to any permanent modifications.
...
Project Mirage will manage and manage information only when appropriate authorization has been granted and in full compliance with all relevant privacy regulations and organizational standards. During initial login, all users are required to formally accept the system’s terms of use, which clearly describe how information is overseen.
